...
enum class SongSectionType(
    ...
    BUILD_UP("BUILD UP 1", 35, "Peningkatan intensitas, snare & perkusi mulai masuk"),
    ...
    DROP("DROP 1", 75, "Pukulan downbeat penuh, kick & bass punchy berdentum"),
    ...
    BUILD_UP_2("BUILD UP 2", 70, "Pembangunan tensi kedua dengan riser & roll intens"),
    MAIN_DROP("MAIN DROP", 90, "Dentuman utama dengan seluruh elemen instrumen aktif"),
